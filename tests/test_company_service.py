...
from app.services.company_service import CompanyService, CompanyNotFoundError, CompanyExistsError
...
class TestCompanyService:
    ...
    def test_list_companies_with_filters(self, company_service: CompanyService):
        ...
        company_service.create_company(CompanyCreate(
            name="UK Tech Company",
            country="GB",
            industry="Technology"
        ))
        company_service.create_company(CompanyCreate(
            name="US Finance Company", 
            country="US",
            industry="Finance"
        ))
    ...
    def test_get_companies_by_postcode(self, company_service: CompanyService):
        ...
        company_service.create_company(CompanyCreate(
            name="London Company 1",
            postcode="SW1A 1AA"
        ))
        company_service.create_company(CompanyCreate(
            name="London Company 2", 
            postcode="SW1B 2BB"
        ))
        company_service.create_company(CompanyCreate(
            name="Manchester Company",
            postcode="M1 1AA"
        ))
...
class TestCompanyServiceIntegration:
    ...
    def test_update_from_companies_house_data(self, company_service: CompanyService):
        ...
        updated_company = company_service.update_from_companies_house(company.id, ch_data)
