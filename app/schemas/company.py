...
class CompanyBase(BaseModel):
    ...
    annual_revenue: Optional[int] = Field(
        default=None,
        ge=0,
        description="Annual revenue in GBP"
    )
...
class CompanyFilter(BaseModel):
    ...
    has_companies_house_data: Optional[bool] = Field(
        default=None,
        description="Filter by whether company has Companies House data"
    )
...
class CompanyList(BaseModel):
    ...
    total_count: int = Field(..., description="Total number of companies matching filters")
